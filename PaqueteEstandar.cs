...
namespace GoXela_P__D
{
    internal class PaqueteEstandar : Paquete
    {
        ...
        public PaqueteEstandar(string codigo, string descripcion, double peso, string direccionOri, string direccionDes, EstadoPaquete estado, int precio, int pase, int cantidadLimite)
