...
namespace GoXela_P__D
{
    internal class PaqueteEstandar : Paquete
    {
        ...
        public PaqueteEstandar(string codigo, string descripcion, double peso, double valorDeclarado, string direccionOrigen, string direccionDestino, EstadoPaquete estado)
