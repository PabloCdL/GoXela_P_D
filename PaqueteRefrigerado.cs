...
namespace GoXela_P__D
{
    internal class PaqueteRefrigerado : Paquete
    {
        ...
        public PaqueteRefrigerado(string codigo, string descripcion, double peso, double valorDeclarado, string direccionOrigen, string direccionDestino, EstadoPaquete estado)
